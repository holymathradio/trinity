...
window.MultiplicationInverseFinalScene = function(svg, callback, cancelCallback, getIsCanceled, setIsCanceled) {
       console.log("MultiplicationInverseFinalScene function called");
