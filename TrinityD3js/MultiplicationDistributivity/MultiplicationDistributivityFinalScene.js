...
window.MultiplicationDistributivityFinalScene = function(svg, callback, cancelCallback, getIsCanceled, setIsCanceled) {
       console.log("MultiplicationDistributivityFinalScene function called");
...
function drawMiddleRectanglesTrace(svg, axes, N, leftPoint, rightPoint, customClass, color, color_rectangle) {
    const rectWidth = 5;
    const rectHeight = 20;
