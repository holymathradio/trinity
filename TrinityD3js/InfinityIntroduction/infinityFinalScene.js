console.log("infinityFinalScene.js loaded");
window.infinityFinalScene = function(svg, callback, cancelCallback, getIsCanceled, setIsCanceled) {
    console.log("infinityFinalScene function called");
