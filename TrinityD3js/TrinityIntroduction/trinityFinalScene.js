console.log("trinityFinalScene.js loaded");
window.trinityFinalScene = function(svg, callback, cancelCallback, getIsCanceled, setIsCanceled) {
    console.log("trinityFinalScene function called");
