...
window.AdditionAssociativityIntro = function(svg, callback, cancelCallback, getIsCanceled, setIsCanceled) {
    console.log("AdditionAssocativityIntro function called");
...
svg.attr("width", maxWidth)
  ...
  .attr("viewBox", `0 0 800 500`);
    ...
    const delayToOperands = 4000; // for additional transition
