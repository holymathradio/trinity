...
window.AdditionAssociativityFinalScene = function(svg, callback, cancelCallback, getIsCanceled, setIsCanceled) {
...
svg.attr("width", maxWidth)
  ...
  .attr("viewBox", `0 0 800 500`);
    ...
    const delayConsolidateSum = 4000; // delay for ex and its brace
