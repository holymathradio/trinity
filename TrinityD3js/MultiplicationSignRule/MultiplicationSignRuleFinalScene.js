...
window.MultiplicationSignRuleFinalScene = function(svg, callback, cancelCallback, getIsCanceled, setIsCanceled) {
       console.log("MultiplicationSignRuleFinalScene function called");
...
// Add a white text "Hate" below the "-" symbol
svg.append("text")
...
// Add a yellow text "Love" below the "+" symbol
svg.append("text")
