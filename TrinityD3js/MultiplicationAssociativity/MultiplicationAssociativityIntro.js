...
window.MultiplicationAssociativityIntro = function(svg, callback, cancelCallback, getIsCanceled, setIsCanceled) {
...
console.log("Arc Parameters:", arcParamsRight);
    ...
    // Define the arrow marker for the middle arrow
    svg.append("defs").append("marker")
        .attr("id", "arrow-right")
        .attr("viewBox", "0 0 20 20")
        .attr("refX", "10")
...
let r_left_shifted = r_left - 5;
    ...
    svg.append("text")
    .attr("class", "label-time-e-pi")
        .attr("x", labelPositionRight[0]-30)
    ...
    svg.append("text")
        .attr("class", "label-time-e-pi")
        .attr("x", axes.c2p(3.4, 0.85)[0])
        .attr("y", axes.c2p(3.4, 0.85)[1])
        .attr("font-size", fontSize)
        .attr("text-anchor", "middle")
        .attr("fill", "grey")
        .text("e * (e' * e'')")
