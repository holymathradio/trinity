...
window.AdditionTotalOrderRight = function(svg, callback, cancelCallback, getIsCanceled, setIsCanceled) {
       console.log("AdditionTotalOrderRight function called");
...
const finalEndPointRight = axes.c2p(4.5, 0);
    ...
    const topBrace = svg.append("path")
        .attr("d", makeCurlyBrace(startPoint[0], startPoint[1] - 20, initialEndPoint[0], initialEndPoint[1] - 20, 20, 0.6, true))
        .attr("fill", "none")
        .attr("stroke", "gray")
        .attr("stroke-width", brace_stroke_width)
        .style("opacity", 1);
...
const bottomBraceR = svg.append("path")
    .attr("d", makeCurlyBrace(initialEndPoint[0], initialEndPoint[1] + 20, initialEndPoint[0], initialEndPoint[1] + 20, 20, 0.6))
    .attr("fill", "none")
    .attr("stroke", "gray")
    .attr("stroke-width", brace_stroke_width)
    .style("opacity", 0);
...
function updateBraceAndLabel(t) {
    const currentEndPoint = [
        initialEndPoint[0] + t * (finalEndPointRight[0] - initialEndPoint[0]),
        initialEndPoint[1] + t * (finalEndPointRight[1] - initialEndPoint[1])
    ];
