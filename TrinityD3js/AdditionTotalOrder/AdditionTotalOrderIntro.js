console.log("AdditionTotalOrderIntro.js loaded");
window.AdditionTotalOrderIntro = function(svg, callback, cancelCallback, getIsCanceled, setIsCanceled) {
    console.log("AdditionTotalOrderIntro function called");
