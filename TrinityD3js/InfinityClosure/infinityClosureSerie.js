console.log("infinityClosureSerie.js loaded");
window.infinityClosureSerie = function(svg, callback, cancelCallback, getIsCanceled, setIsCanceled) {
    console.log("infinityClosureSerie function called");
...
svg.attr("width", maxWidth)
  ...
  .attr("viewBox", `0 0 800 500`);
    ...
    const delayShift = 2000 ;
    const durationShift = 4000 ;

    const delayAlign = delayShift + durationShift + 4000 ;
    const durationAlign = 3000 ;



    const totalDuration = delayAlign + durationAlign + 500;
...
//update
    ...
    bottomBraceLabel_eprime.transition()
        ...
        .attr("y", startPoint_eprime_aligned[1] + 70*mobileRatioLight);
