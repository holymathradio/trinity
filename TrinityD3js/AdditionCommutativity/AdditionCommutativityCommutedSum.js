...
window.AdditionCommutativityCommutedSum = function(svg, callback, cancelCallback, getIsCanceled, setIsCanceled) {
    ...
    const delayShift = 3000; // delay for ex and its brace
    const durationShift = 5000; // duration for ex and its brace



    const totalDuration = delayShift + durationShift + 1000 ;
